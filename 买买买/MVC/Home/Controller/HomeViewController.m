...
- (void)_createNavBar
{
    _searchButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 35, 12, 20, 20)];
    [_searchButton setBackgroundImage:[UIImage imageNamed:@"Feed_SearchBtn@2x"] forState:UIControlStateNormal];
...
//    NSString *urlString1 = @"http://www.liwushuo.com/posts/1009739";
//    AFHTTPSessionManager *manager1 = [AFHTTPSessionManager manager];
//    manager1.requestSerializer = [AFHTTPRequestSerializer serializer];
//    manager1.responseSerializer = [AFJSONResponseSerializer serializerWithReadingOptions:NSJSONReadingMutableContainers];
//    
//    [manager1 GET:urlString1 parameters:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
//        
//        //        NSLog(@"响应对象:%@", task.response);
//        
//        //responseObject是已经过JSON解析后的数据
