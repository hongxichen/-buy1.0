...
//        _nameTextView.contentMode = UIViewContentModeBottom;
        ...
        _priceLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, (kScreenWidth - 30) * 3 / 4 - 35, (kScreenWidth - 30) / 4 - 10, 30)];
        _priceLabel.textColor = [UIColor redColor];
        
        _goodView = [[UIView alloc] initWithFrame:CGRectMake((kScreenWidth - 30) / 2 - 80, (kScreenWidth - 30) * 3 / 4 - 35, 80, 30)];
